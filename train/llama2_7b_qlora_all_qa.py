...
#######################################################################
# Model
pretrained_model_name_or_path = '/mnt/qjx/llama2_7b_qlora_all_tasks/llama2_7b_qlora_all_tasks_20.pth/'

# Data
data_path = 'log_data/QA_data/log_qa_alpaca.json'
TEMPLATE = ConfigDict(
        log = dict(
        INSTRUCTION_START=(
